...
- [Бойові машини](https://uadata.net/vtraty-rf:bbm.data): **6124** [CSV](/vtraty-rf/bbm.csv)  [API](https://uadata.net/api?e=1) 
- [Літаки](https://uadata.net/vtraty-rf:planes.data): **285** [CSV](/vtraty-rf/planes.csv)  [API](https://uadata.net/api?e=2) 
- [Танки](https://uadata.net/vtraty-rf:tanks.data): **3064** [CSV](/vtraty-rf/tanks.csv)  [API](https://uadata.net/api?e=3) 
- [Артилерійські системи](https://uadata.net/vtraty-rf:artilery.data): **2059** [CSV](/vtraty-rf/artilery.csv)  [API](https://uadata.net/api?e=4) 
...
- [Автомобільна техніка](https://uadata.net/vtraty-rf:auto.data): **4797** [CSV](/vtraty-rf/auto.csv)  [API](https://uadata.net/api?e=8) 
...
- [Особовий склад](https://uadata.net/vtraty-rf.data): **110250** [CSV](/vtraty-rf.csv)  [API](https://uadata.net/api?e=12) 
...
- [Воєнні злочини РФ](https://uadata.net/zlochiny-rf:registered-crimes.data): **62676** [CSV](/zlochiny-rf/registered-crimes.csv)  [API](https://uadata.net/api?e=14) 
...
- [Кількість вакансій по містах](https://uadata.net/rynok-praci.data): **21748** [CSV](/rynok-praci.csv)  [API](https://uadata.net/api?e=35) 
- [Кількість вакансій по професіях](https://uadata.net/rynok-praci:positions.data): **21748** [CSV](/rynok-praci/positions.csv)  [API](https://uadata.net/api?e=36) 
...
- [Оголошення про послуги](https://uadata.net/poslugy.data) [CSV](/poslugy.csv)  [API](https://uadata.net/api?e=40) 
...
- [Продаж авто за типом двигуна](https://uadata.net/automobiles.data): **139959** [CSV](/automobiles.csv)  [API](https://uadata.net/api?e=41) 
- [Продаж авто за діапазоном цін](https://uadata.net/automobiles:auto-prices.data): **176151** [CSV](/automobiles/auto-prices.csv)  [API](https://uadata.net/api?e=42) 

## [Статистика репетиторів в Україні](https://uadata.net/tutors.data)
Оновлено **2023-01-06**

- [Кількість репетиторів по містах](https://uadata.net/tutors.data): **51838** [CSV](/tutors.csv)  [API](https://uadata.net/api?e=43) 
- [Кількість репетиторів по предметах](https://uadata.net/tutors:tutor-subjects.data): **51838** [CSV](/tutors/tutor-subjects.csv)  [API](https://uadata.net/api?e=44) 

## [Статистика оренди та продажу квартир в Україні](https://uadata.net/flats.data)
Оновлено **2023-01-06**

- [Оренда квартир](https://uadata.net/flats.data): **48715** [CSV](/flats.csv)  [API](https://uadata.net/api?e=45) 
- [Продаж квартир](https://uadata.net/flats:sell-flat.data): **166717** [CSV](/flats/sell-flat.csv)  [API](https://uadata.net/api?e=46) 
...
- [Вітрина цін на сигарети](https://uadata.net/ciny-na-producty:meals-price-cigarety.data): **75.15** [CSV](/ciny-na-producty/meals-price-cigarety.csv)  [API](https://uadata.net/api?e=57) 
...
- [Ціни на нафту BRENT](https://uadata.net/ciny-na-naftu.data): **79.0496** [CSV](/ciny-na-naftu.csv)  [API](https://uadata.net/api?e=59) 
